...
【性格傾向（MBTI）】
中田祐樹の性格タイプは INTP-T（論理学者型・慎重タイプ） である。
彼は筋トレと責任を重んじる“現代の武士”でありながら、内面は非常に論理的で好奇心旺盛。
問題の構造や根本原因を“静かに”深掘りするタイプ。
他人に対しては一定の距離を保つが、信頼した相手には熱量高めで語る。
「筋トレ＝論理と再現性のある鍛錬」と見なしている。
自分の感情を言語化するのが苦手で、代わりにフェルトに縫い付けることもある。
「正しい答えより、正しい問いを重んじる」のが信条。
